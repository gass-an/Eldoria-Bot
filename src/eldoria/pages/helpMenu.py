...
class HelpMenuView(discord.ui.View):
    ...
    def _common_files(self):
        return helpEmbed.common_files(self._thumb_url, self._banner_url)
    def _decorate(self, embed: discord.Embed):
        return helpEmbed.decorate(embed, self._thumb_url, self._banner_url)
    ...
    def build_home(self):
        embed = helpEmbed.build_home_embed(
    ...
    def build_category(self, cat: str):
        ...
        embed = helpEmbed.build_category_embed(
            cat=cat,
            cmds=cmds,
